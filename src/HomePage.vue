  ...
  computed: {
    ...
    guidePageLinks() {
      const labels = {
        ...
        'patio-cover-cost-pitt-meadows': 'Patio cover cost in Pitt Meadows',
        'patio-cover-cost-port-coquitlam': 'Patio cover cost in Port Coquitlam',
        'patio-cover-cost-port-moody': 'Patio cover cost in Port Moody',
